...
$(CONFIGURE_ARTIFACT): $(EXTRACT_ARTIFACT)
	cd $(TARGET_BUILD_PATH); CFLAGS='-I$(INSTALL_INCLUDE_PATH)/ncurses' LIBEVENT_CFLAGS='-I$(INSTALL_INCLUDE_PATH) -I/usr/include' LIBEVENT_LIBS='-L$(INSTALL_LIB_PATH) -levent' ./configure --prefix=$(INSTALL_PATH) --enable-static
